...
osarch () {
    ...
    r=" asciidoc asciidoctor autoconf automake binutils cmake fontconfig fribidi gcc gdk-pixbuf2 librsvg gettext git libice libsm libtool libx11 libxext libxft libxinerama libxrandr libxrender libpng libjpeg libxpm make discount perl xdg-utils xterm xorg-xmessage "
...
debian () {
    ...
    r=" asciidoctor autoconf automake autopoint build-essential cmake gettext git libfontconfig1-dev libfribidi-dev libgdk-pixbuf2.0-dev libtool libsm-dev libx11-dev libxext-dev libxft-dev libxinerama-dev libxrandr-dev libxrender-dev libpng-dev libjpeg-dev libxpm-dev librsvg2-dev xterm xdg-utils "
...
opensuse () {
    ...
    r=" alsa-devel asciidoc autoconf automake fontconfig-devel fribidi-devel gdk-pixbuf-devel gettext gettext-tools git libSM-devel libX11-devel libXext-devel libXft-devel libXinerama-devel libXrandr-devel libXrender-devel libpng16-devel libjpeg62-devel libXpm-devel libtool xterm xdg-utils "
