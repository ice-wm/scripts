...
debian () {
    ...
    r=" asciidoctor autoconf automake autopoint build-essential cmake gettext git libfontconfig1-dev libfribidi-dev libgdk-pixbuf2.0-dev libtool libsm-dev libx11-dev libxext-dev libxft-dev libxinerama-dev libxrandr-dev libxrender-dev libxcomposite-dev libxdamage-dev libxfixes-dev libpng-dev libjpeg-dev libxpm-dev librsvg2-dev xterm xdg-utils "
