...
debian () {
    ...
    sed -i -e '/-base\//d' $t
    r=" asciidoctor autoconf automake autopoint build-essential cmake fonts-dejavu gettext git libfontconfig1-dev libfribidi-dev libgdk-pixbuf-2.0-dev libimlib2-dev libtool libsm-dev libx11-dev libxext-dev libxft-dev libxinerama-dev libxrandr-dev libxrender-dev libxcursor-dev libxcomposite-dev libxdamage-dev libxfixes-dev libxres-dev libpng-dev libjpeg-dev libxpm-dev librsvg2-dev lzip markdown x11-utils xterm xdg-utils yad "
...
ubuntu () {
    ...
    sed -i -e '/-base\//d' $t
    r=" asciidoctor autoconf automake autopoint build-essential cmake fonts-dejavu gettext git libfontconfig1-dev libfribidi-dev libgdk-pixbuf2.0-dev libimlib2-dev libtool libsm-dev libx11-dev libxext-dev libxft-dev libxinerama-dev libxrandr-dev libxrender-dev libxcursor-dev libxcomposite-dev libxdamage-dev libxfixes-dev libxres-dev libpng-dev libjpeg-dev libxpm-dev librsvg2-dev lzip markdown x11-utils xterm xdg-utils yad "
    [ $sound = 1 ] && snd=" libao-dev libasound2-dev libsndfile1-dev libpulse-dev" || snd=
    [ $noask = 1 ] && ask=--yes || ask=
    i=
    for p in $r $snd
...
openbsd () {
    ...
    r=" asciidoc autoconf automake cmake dejavu-ttf freetype fribidi g++ gettext-tools git gmake imlib2 libao libsndfile libtool lxrandr lzip jpeg png py3-markdown"
    [ $sound = 1 ] && snd=" libao libsndfile" || snd=
    [ $noask = 1 ] && ask=-I || ask=
    i=
    for p in $r $snd
